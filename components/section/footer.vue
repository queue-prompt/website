<template>
  <div class="bg-green px-4 lg:px-0 py-10 lg:py-32">
    <div class="w-full lg:flex justify-between mx-auto container">
      <div class="w-full text-center">
        <h1
          class="text-xl lg:text-4xl mb-4 tracking-1px text-center text-white"
        >
          ช่องทางการติดต่อ
        </h1>
      ...
      <!-- <div class="lg:w-1/2 justify-between lg:flex">
                                ...
                                <a href="" class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                        ...
                                        <path
                                            ...
                                            stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M14.9988 5.00117V5.00322" stroke="#10A254" stroke-linecap="round"
            ...
            <div class="w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center lg:justify-end">
                <div class="w-10/12 lg:w-1/2">
                    <h1 class="text-lg text-white font-semibold tracking-wide mb-6 text-center lg:text-left">Subscribe
                        to our Newsletter</h1>
                    <div class="flex justify-center">
                        <div class="w-full bg-white rounded-2xl flex justify-center items-center rounded relative">
                            <input type="email" required="" placeholder="Your Email" id="email" aria-label="email"
                            ...
                            <button type="submit"
                                class="absolute right-0 inset-y-0 h-full focus:outline-none transition duration-150 border-l border-gray-300 text-xs lg:text-base font-medium text-green ease-in-out rounded text-white px-2 sm:px-6 py-2 lg:py-4">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div> -->
